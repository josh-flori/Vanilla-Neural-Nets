...
'''' For a 3 layer network...
     ...
     FIRST LAYER (W1)
     ----------     ----------     ----------     ----------     ----------
     X.shape = (nx,m) pixel count by number of images (53100, 207)
     W1.shape = (node_count,nx) pixel count by number of images (3, 53100)
     Z/A1 = WX + b = np.dot(W,X) = np.dot((node_count,nx),(nx,m)) = (3, 53100)*(53100, 207) =  (node_count,m) = (3,207)
     ----------     ----------     ----------     ----------     ----------
     NEXT LAYER (W2)
     ----------     ----------     ----------     ----------     ----------
     A1.shape = (node_count,m) = (3,207)
     W2.shape = (node_count,node_count_previous) (3,3)
     Z/A2 = WX + b = np.dot(W,X) = np.dot((node_count,node_count_previous),(node_count_previous,m)) = (3,3)*(3,207) =  (node_count,m) = (3,207)
     ----------     ----------     ----------     ----------     ----------
     NEXT LAYER (W3)
     ----------     ----------     ----------     ----------     ----------
     A2.shape = (node_count,m) = (3,207)
     W3.shape = (node_count,node_count_previous) = (3,3)
     Z/A3 = WX + b = np.dot(W,X) = np.dot((node_count,node_count_previous),(node_count_previous,m)) = (3,3)*(3,207)  =  (node_count,m) = (3,207)
     ----------     ----------     ----------     ----------     ----------
     FINAL LAYER (W3)
     ----------     ----------     ----------     ----------     ----------
     A3.shape = (node_count,m) = (3,207)
     W4.shape = (node_count,node_count_previous) (1,3)
     Z/A3 = WX + b = np.dot(W,X) = np.dot((node_count,node_count_previous),(node_count_previous,m)) = (1,3)*(3,207) =  (node_count,m) = (1,207) = y_hat = compare to Y, which is 1,207
     ----------     ----------     ----------     ----------     ----------
